...
function WebSocket (mng, data, req) {
  ...
  var self = this;
  // If we create a WS transport before the upgrade happens, which gives us a wsclient,
  // then we want to consider this transport closed
  if (!req.wsclient || typeof req.wsclient !== "object") {
